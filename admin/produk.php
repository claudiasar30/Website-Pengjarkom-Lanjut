s<button type="button" class="btn btn-dis">PRODUK</button>&raquo;
...
while($rp = mysqli_fetch_array($sqlp)){
    ...
    echo "<br><a href='?p=produkdetail&id=$rp[idproduk]'><button type='button' class='btn btn-add'>Detail</button></a>
          <a href='?p=produkedit&id=$rp[idproduk]'><button type='button' class='btn btn-add'>Edit Produk</button>
...
echo "Total Prosuk <span class='kotak'><b>$jmldata</b></span>";
echo "<p></div>";
echo "<p>&nbsp;</p>";
?>